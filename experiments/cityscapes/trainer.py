...
def main(path, lr, bs, device):
    ...
    for epoch in epoch_iter:
        ...
        weight_method.method.tele_count = 0
        for j, batch in enumerate(train_loader):
            ...
            kwargs = {"opt": args, "multi_task_model":model,"train_loader":lora_loader, 'cur_data':[train_data, train_label, train_depth], 'epoch':epoch, 'optimizer': optimizer}
    ...
    print('TEST: {:.4f} {:.4f} {:.4f} | {:.4f} {:.4f} {:.4f} | delta m: {:.4f}'

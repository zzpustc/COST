...
common_parser.add_argument( 
    "--method", default='fairgrad', type=str, help="MTL weight method"
)
...
# fairgrad
common_parser.add_argument("--alpha", type=float, default=2.0, help="alpha for FairGrad alg.")
# famo
...
common_parser.add_argument("--dataset", type=str, default='city', help="only support ['city', 'nyuv2', 'celeba', 'qm9']")
common_parser.add_argument("--lora_epoch", type=int, default=0, help="Epoch when start teleportation")
common_parser.add_argument("--tele_sign", type=bool, default=False, help="Turn on/off teleportation")
common_parser.add_argument("--tele_times_per_epoch", type=int, default=1, help="Allowed teleportation times per epoch")
common_parser.add_argument("--tele_round", type=int, default=2, help="LoRA optimization round per teleportation")
common_parser.add_argument("--grad_sampling_times", type=int, default=5, help="Sampling times for gradient estimaton")
